...
- [ ] Read PRD thoroughly (`docs/prds/pr-2-prd.md`)
- [ ] Read `.cursorrules` for Electron/React patterns
- [ ] Read `prd-v1.md` Phase 2 requirements
- [ ] Verify FFmpeg installed: Check `node_modules/ffmpeg-static`
- [ ] Test Electron dev server works: `npm start`
...
- [ ] Create `src/main/fileSystem.ts` with temp directory setup
...
- [ ] Create `src/main/ffmpeg.ts` for metadata extraction
...
- [ ] Add thumbnail generation to `src/main/ffmpeg.ts`
...
- [ ] Add error handling to FFmpeg functions
...
- [ ] Create `src/main/ipcHandlers.ts` file
  - Test Gate: File created, imports ipcMain from 'electron'

- [ ] Implement `file:select` IPC handler
...
- [ ] Implement `file:getMetadata` IPC handler
...
- [ ] Implement `file:getThumbnail` IPC handler
...
- [ ] Register all IPC handlers in `src/main.ts`
...
- [ ] Update `src/preload.ts` to expose new IPC methods
...
- [ ] Create `src/components/LibraryClipCard.tsx`
...
- [ ] Add styling to LibraryClipCard
...
- [ ] Add hover state to LibraryClipCard
...
- [ ] Create `src/hooks/useFileImport.ts` custom hook
...
- [ ] Implement file validation in useFileImport
...
- [ ] Implement import process in useFileImport
  - For each valid file:
...
- [ ] Add progress tracking to useFileImport
...
- [ ] Add error handling to useFileImport
...
- [ ] Update `src/components/Library.tsx` to add import button
...
- [ ] Add drag-and-drop zone to Library.tsx
...
- [ ] Add state management to Library.tsx
...
- [ ] Render LibraryClipCard components
...
- [ ] Add scrollable container to Library
...
- [ ] Update `src/App.tsx` to manage library state
...
- [ ] Pass import handlers to Library component
...
- [ ] Add drag-over highlight styles to `src/index.css`
...
- [ ] Test drag-and-drop import end-to-end
...
- [ ] Test file picker import end-to-end
...
- [ ] Test memory usage with 10 clips
...
- [ ] Test drag-and-drop with mixed file types
...
- [ ] Verify temp directory on macOS
...
- [ ] Add inline JSDoc comments to IPC handlers
...
- [ ] All FFmpeg integration gates pass
